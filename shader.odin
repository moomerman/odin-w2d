...
set_shader :: proc(shader: ^Shader) {
	ctx.renderer.set_shader(shader)
}
...
destroy_shader :: proc(shader: ^Shader) {
	ctx.renderer.destroy_shader(shader)
}
